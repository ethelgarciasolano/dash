...
const btn4 = document.getElementById('hide4');

btn4.addEventListener('click', () => {

  if (document.getElementById("table4").style.visibility === "visible") {
    ...
    document.getElementById("table4").style.height= '100%';
  }
...
btn5.addEventListener('click', () => {
  ...
  if (document.getElementById("table5").style.visibility === "visible") {
    ...
    document.getElementById("table5").style.height= '100%';
  }
...
btn6.addEventListener('click', () => {
  ...
  if (document.getElementById("table6").style.visibility === "visible") {
    ...
    document.getElementById("table6").style.height= '100%';
  }
