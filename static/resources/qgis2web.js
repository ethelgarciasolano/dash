...
map.getView().fit([-9114583.423030, -568581.192534, -7050621.407069, 574337.608215], map.getSize());
    ...
    map.forEachFeatureAtPixel(pixel, function(feature, layer) {
        ...
        if (typeof clusteredFeatures !== "undefined") {
            ...
            if (doPopup) {
                ...
                for (var i=0; i<8; i++) {
                    if (currentFeatureKeys[i] != 'geometry' && currentFeatureKeys[i] != 'Shape_Area'&& currentFeatureKeys[i] != 'RuleID'&& currentFeatureKeys[i] != 'OBJECTID' && currentFeatureKeys[i] !='id') {
                        popupField = '';
                        if (layer.get('fieldLabels')[currentFeatureKeys[i]] == "inline label") {
                            popupField += '<th>' + layer.get('fieldAliases')[currentFeatureKeys[i]] + ':</th><td>';
                        } else {
